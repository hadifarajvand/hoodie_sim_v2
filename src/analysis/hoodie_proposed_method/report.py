...
def _component_definitions() -> tuple[ComponentCoverageEntry, ...]:
    return (
        ...
        ComponentCoverageEntry(
            ...
            current_implementation="The model now accepts PolicyContext, scores legal local/horizontal/vertical actions with paper-shaped load and deadline hints, and records decision traces without claiming a full trainer.",
            ...
            status="implemented",
            gap="none",
            required_repair="No repair required for the distributed decision contract.",
        ),
        ComponentCoverageEntry(
        ...
        ComponentCoverageEntry(
            ...
            current_implementation="Replay storage now has bounded capacity, FIFO eviction, deterministic batch sampling, and a random-sampling path for training-like usage.",
            implementation_reference="src/analysis/hoodie_proposed_method/learning_model.py; src/agents/replay_buffer.py",
            status="implemented",
            gap="none",
            required_repair="No repair required for the replay memory contract.",
        ),
        ComponentCoverageEntry(
