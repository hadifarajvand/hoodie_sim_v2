...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--algorithm-fidelity-repair", action="store_true", help="run the algorithm-fidelity repair smoke [50..1000]")
    ...
    if args.reward_signal_repair:
        ...
        return 0
    if args.algorithm_fidelity_repair:
        from src.analysis.algorithm_fidelity_against_paper_repair.runner import run as run_algorithm_fidelity_repair

        run_algorithm_fidelity_repair(emit_json=args.json)
        return 0
