...
class SelectedActionFamilyEvidenceRecord:
    strategy: str
    seed: int
...
@dataclass(frozen=True, slots=True)
class SelectedActionTaskJoinRecord:
    strategy: str
    seed: int
...
@dataclass(frozen=True, slots=True)
class PerActionOutcomeJoinRecord:
    action_family: str
    per_action_completion_count: int | None
    per_action_drop_count: int | None
    per_action_pending_count: int | None
    per_action_completion_rate: float | None
    per_action_drop_rate: float | None
    per_action_pending_rate: float | None
...
@dataclass(frozen=True, slots=True)
class SelectedActionOutcomeEvidenceReport:
    feature_id: str
    ...
    evidence_population_summary: dict[str, Any]
    ...
    recommended_next_feature: str = "selected-action family trace repair before training"
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "evidence_population_summary": dict(self.evidence_population_summary),
