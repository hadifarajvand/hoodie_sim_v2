...
from .report import build_feature_074_report, render_feature_074_report, write_feature_074_report


class BaselinePolicyComparativeEvaluationReadinessRunner:
    ...
    def write(self) -> Path:
        return write_feature_074_report(self.output_dir)
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if "--json" in args:
        ...
        print(render_feature_074_report(report))
    write_feature_074_report(output_dir)
    return 0
