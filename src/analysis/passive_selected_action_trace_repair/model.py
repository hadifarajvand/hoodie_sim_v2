...
class TerminalOutcomeJoinKeySummary:
    terminal_outcome_join_count: int | None
    terminal_outcome_join_ratio: float | None
    missing_terminal_outcome_join_count: int | None
...
class PassiveSelectedActionTraceRepairReport:
    ...
    def __post_init__(self) -> None:
        behavior_passed = self.behavior_equivalence_summary.passed if hasattr(self.behavior_equivalence_summary, "passed") else None
        if behavior_passed is not None and behavior_passed != self.behavior_equivalence_summary.passed:
            raise ValueError("behavior_equivalence_summary.passed must be self-consistent")
