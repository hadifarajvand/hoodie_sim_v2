...
def _render_markdown(payload: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            f"- decision_opportunity_count: `{payload['decision_opportunity_count']}`",
            f"- selected_action_trace_record_count: `{payload['selected_action_trace_record_count']}`",
            f"- selected_action_family_trace_record_count: `{payload['selected_action_family_trace_record_count']}`",
            f"- selected_action_to_task_join_key_count: `{payload['selected_action_to_task_join_key_count']}`",
            f"- terminal_outcome_join_key_count: `{payload['terminal_outcome_join_key_count']}`",
            ...
            f"- selected_action_trace_coverage_ratio: `{payload['selected_action_trace_coverage_ratio']}`",
            f"- selected_action_family_coverage_ratio: `{payload['selected_action_family_coverage_ratio']}`",
            f"- selected_action_to_task_join_coverage_ratio: `{payload['selected_action_to_task_join_coverage_ratio']}`",
            f"- terminal_outcome_join_key_coverage_ratio: `{payload['terminal_outcome_join_key_coverage_ratio']}`",
            "",
            ...
            _json_dump(
                {
                    ...
                    "decision_opportunity_count": payload["decision_opportunity_count"],
                    "selected_action_trace_record_count": payload["selected_action_trace_record_count"],
                    "selected_action_family_trace_record_count": payload["selected_action_family_trace_record_count"],
                    "selected_action_to_task_join_key_count": payload["selected_action_to_task_join_key_count"],
                    "terminal_outcome_join_key_count": payload["terminal_outcome_join_key_count"],
                    "selected_action_trace_coverage_ratio": payload["selected_action_trace_coverage_ratio"],
                    "selected_action_family_coverage_ratio": payload["selected_action_family_coverage_ratio"],
                    "selected_action_to_task_join_coverage_ratio": payload["selected_action_to_task_join_coverage_ratio"],
                    "terminal_outcome_join_key_coverage_ratio": payload["terminal_outcome_join_key_coverage_ratio"],
