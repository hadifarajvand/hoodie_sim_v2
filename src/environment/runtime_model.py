...
class SharedRuntimeParameters:
    slot_duration: float = float(_RUNTIME_CONFIG.get("slot_duration", 0.1))
    local_service_capacity: float = float(_RUNTIME_CONFIG.get("local_service_capacity", 0.5))
    public_service_capacity: float = float(_RUNTIME_CONFIG.get("public_service_capacity", 0.5))
