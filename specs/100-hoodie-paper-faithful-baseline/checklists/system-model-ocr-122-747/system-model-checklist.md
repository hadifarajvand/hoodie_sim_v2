...
| T-06 | Action legality linkage | Topology should drive horizontal action legality | `environment/matchmaker.py`, phase 2 repair | PARTIAL | Legal action checks exist, but output contract is not yet explicit | Record legality source in run config |
