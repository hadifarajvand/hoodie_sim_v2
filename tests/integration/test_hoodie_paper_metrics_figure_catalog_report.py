...
class HoodiePaperMetricsFigureCatalogIntegrationTests(unittest.TestCase):
    ...
    def test_feature_089_artifact_manifest_contains_required_files(self) -> None:
        ...
        self.assertEqual({entry["status"] for entry in plot_manifest["entries"] if entry["figure_id"] in {"Figure 8a", "Figure 8b", "Figure 11"}}, {"gated_status_generated"})
        self.assertEqual({entry["status"] for entry in plot_manifest["entries"] if entry["figure_id"] in {"Figure 9a", "Figure 9b", "Figure 9c", "Figure 9d", "Figure 9e"}}, {"generated"})
        self.assertEqual({entry["status"] for entry in plot_manifest["entries"] if entry["figure_id"] in {"Figure 10a", "Figure 10b", "Figure 10c", "Figure 10d", "Figure 10e", "Figure 10f"}}, {"generated"})
