...
class HoodieProposedMethodReportIntegrationTests(unittest.TestCase):
    ...
    def test_report_renders_honestly_without_ranking_or_baselines(self) -> None:
        ...
        self.assertIn("remaining partial component is a learning internal expected to be implemented later.", rendered)
        self.assertIn("next partial targets: lstm_forecast_recovery_interface.", rendered)
