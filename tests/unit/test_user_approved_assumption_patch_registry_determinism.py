...
class UserApprovedAssumptionPatchRegistryDeterminismTest(unittest.TestCase):
    ...
    def test_runtime_approved_item_is_confined_to_figure_7(self) -> None:
        ...
        self.assertEqual([item["item_id"] for item in report["runtime_usable_items"]], ["Figure_7_adjacency", "legal_horizontal_destinations", "EA_private_cpu_capacity", "EA_public_cpu_capacity", "cloud_cpu_capacity", "cloud_data_rate"])
        self.assertEqual(report["status_counts"]["approved"], 6)
